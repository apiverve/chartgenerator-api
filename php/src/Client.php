...
namespace APIVerve\Chartgenerator;
...
/**
 * Client for the Chart Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://chartgenerator.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/chartgenerator';
    ...
    private const VALIDATION_RULES = [
        ...
        'width' => ['type' => 'integer', 'required' => false, 'min' => 100, 'max' => 1024],
        'height' => ['type' => 'integer', 'required' => false, 'min' => 100, 'max' => 1024],
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\ChartgeneratorClient] {$message}\n";
        }
    }
}
