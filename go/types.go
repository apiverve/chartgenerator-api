// Package chartgenerator provides a Go client for the Chart Generator API.
//
// For more information, visit: https://chartgenerator.apiverve.com?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Chart Generator API.
//
// Parameters:
//   - type: string - Chart type
//   - labels (required): array - Array of labels for the x-axis or chart segments
//   - datasets (required): array - Array of datasets with 'name' and 'values'
//   - title: string - Optional title displayed on the chart
//   - width: integer - Image width in pixels [min: 100, max: 1024]
//   - height: integer - Image height in pixels [min: 100, max: 1024]
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"width": {Type: "integer", Required: false, Min: float64Ptr(100), Max: float64Ptr(1024)},
		"height": {Type: "integer", Required: false, Min: float64Ptr(100), Max: float64Ptr(1024)},
...
// ResponseData contains the data returned by the Chart Generator API.
