...
```gradle
dependencies {
    implementation 'com.github.apiverve:chartgenerator-api:1.1.14'
}
```
...
```java
import com.apiverve.chartgenerator.ChartGeneratorAPIClient;
import com.apiverve.chartgenerator.APIResponse;
import com.apiverve.chartgenerator.APIException;

// Initialize the client
ChartGeneratorAPIClient client = new ChartGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/chartgenerator](https://docs.apiverve.com/ref/chartgenerator)
...
- **Documentation:** [https://docs.apiverve.com/ref/chartgenerator](https://docs.apiverve.com/ref/chartgenerator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/chartgenerator-api/issues)
