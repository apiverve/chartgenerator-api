...
namespace APIVerve.API.ChartGenerator
{
    ...
    /// <summary>
    /// Client for the ChartGenerator API
    /// </summary>
...
#endif
    {
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "labels", new ValidationRule { Type = "array", Required = true } },
            { "datasets", new ValidationRule { Type = "array", Required = true } },
            { "title", new ValidationRule { Type = "string", Required = false } },
            { "width", new ValidationRule { Type = "integer", Required = false, Min = 100, Max = 1024 } },
            { "height", new ValidationRule { Type = "integer", Required = false, Min = 100, Max = 1024 } },
        ...
        public ChartGeneratorAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ChartGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ChartGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        private void ValidateParams(ChartGeneratorQueryOptions options)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(ChartGeneratorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(ChartGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(ChartGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(ChartGeneratorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(ChartGeneratorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
